...
output_folder = 'E:/BME/YOLO/test_predict/inferTs'
input_folder = 'E:/BME/YOLO/test_predict/imageTs'  # 输入文件夹

# 加载模型
model = YOLO('E:/BME/YOLO/liver_tumor_detect/weights/best.pt')
